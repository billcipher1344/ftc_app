...
public class HardwareVortex {
    ...
    // SENSORS
    public LightSensor lightLeft, lightRight;
    ...
    public final static double LIMIT_ON = 1.0, LIMIT_OFF = 0.0;
    ...
    public void init(HardwareMap hardwareMap) {
        ...
        limit = hardwareMap.servo.get("limit");
        limit.setPosition(LIMIT_OFF);
